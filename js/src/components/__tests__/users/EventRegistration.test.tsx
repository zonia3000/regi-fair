...
describe("Event registration", () => {
  ...
  test("Edit existing registration", async () => {
    ...
    server.use(
      ...
      http.get("/regifair/v1/events/1/1234", () => {
        return HttpResponse.json({ values: { 1: "myvalue" } });
      }),
      http.post("/regifair/v1/events/1/1234", async ({ request }) => {
  ...
  test("Delete existing registration", async () => {
    ...
    server.use(
      ...
      http.post("/regifair/v1/events/1/1234", () => {
  ...
  test("Editing event in waiting list", async () => {
    ...
    server.use(
      ...
      http.get("/regifair/v1/events/1/5555", () => {
        return HttpResponse.json({
          values: { 1: "myvalue" },
          waitingList: true,
        });
